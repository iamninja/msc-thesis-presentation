...
\begin{frame}[t]\frametitle{Cuts and Noncuts}
	...
	\begin{exampleblock}{Example}<2->
		...
		\begin{overlayarea}{\textwidth}{2cm}
			\only<2>{\centering\includegraphics[height=1.5cm,width=11cm]{cut--.pdf}\par}
			\only<3>{\centering\includegraphics[height=1.5cm,width=11cm]{noncut1--.pdf}\par}
			\only<4>{\centering\includegraphics[height=1.5cm,width=11cm]{noncut2--.pdf}\par}
		\end{overlayarea}
...
\begin{frame}[t]\frametitle{Trichotomy Theorem}
	...
	\begin{exampleblock}{Example}<2->
		...
		\centering\includegraphics[height=1.25cm,width=12cm]{trichotomy--.pdf}\par
